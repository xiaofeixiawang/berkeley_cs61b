...
class Date {
	...
	public Date(String s) {
		month = Integer.parseInt(s.split("/")[0]);
		day = Integer.parseInt(s.split("/")[1]);
	...
	public static boolean isValidDate(int month, int day, int year) {
		...
		if (month < 1 || month > 12)
			return false;
		return day == daysInMonth(month, year); // replace this line with your
												// solution
	}
	 ...
	 * this Date occurs before d, the result is negative. 1992/12/2-1990/12/12
	 * 
