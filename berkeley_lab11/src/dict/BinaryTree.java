...
public class BinaryTree implements Dictionary {
  ...
  public Entry remove(Object key) {
	  ...
	  if(found.parent==null){
		  if(found.leftChild==null&&found.rightChild==null){
			  ...
			  BinaryTreeNode tmp=findSmall(found.rightChild);
			  found.entry=tmp.entry;
  ...
  public BinaryTreeNode findSmall(BinaryTreeNode node){
	  if(node.leftChild==null)return node;
	  else{
		  return findSmall(node.leftChild);
	  }
  }
